  ...
  let listNames = listContents.map(content => {
    ...
    let left = `<div class="left-wrapper">
                    <div class="gx-left-content">
                        ${
                          content.titleHeader
                            ? content.titleHeader.firstTopic()
                            : ""
                        }
    ...
    let zMiddle = `<div class="gx-row-flex-center">${
      content.zmiddle ? content.zmiddle : ""
    }</div>`;
    let items = content.tableContents ? content.tableContents.map( column =>{
                var columnItems =  
                `<div class="gx-col-flex gx-table-items">
    ...
    let tableList = `<div class="gx-table-list">${content.tableContents?items.join(""):""}</div>`;

    //`<img src="Group 216.png"></img>`;
    let container = `<li style="display:flex;flex-direction:column;justify-content:center;">
                ...
                <div style="display:flex;flex-direction:row;justify-content:center;"><p style="width:100%;max-width:850px;padding:0 10px;">${
